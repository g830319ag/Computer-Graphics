...
void Camera::move(GLFWwindow* window) {
  ...
  //   glm::quat rx(glm::angleAxis(-mouseMoveSpeed, glm::vec3(0, -1, 0)));
  ...
  //   glm::quat ry(glm::angleAxis(mouseMoveSpeed, glm::vec3(1, 0, 0)));
...
void Camera::updateViewMatrix() {
  ...
  viewMatrix = glm::lookAt(position, position+front, up); // (camera position, object position, up vector)
}
